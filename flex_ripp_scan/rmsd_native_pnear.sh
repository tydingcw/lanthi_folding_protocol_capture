...
~/anaconda3/envs/py27/bin/python ${PRE}plot_folding_funnel.py -input $INPUT -pnear -pnear_lambda 1.5 -pnear_kbt 0.62 -delimiter ' ' -z_str total_score -output ${tag}.rmsd-to-best_energy.png -y_label "Energy (REU)" -cmap terrain -x_str rmsd_bb -y_str total_score
